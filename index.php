...
<head>
 ...
 <script type="text/javascript" src="externa.js" defer></script>
</head>
<body>
 <?php
     ...
     //SECCION DE LA GALERIA JS
     echo
     '
          <section id="galeria">
               <input type="button" class="btn btn-primary" id="cambiar" value="Cambiar imagenes">
               <table>
                    <thead><th>IMAGENES</th></thead>
                    <tbody id="lista">
                    </tbody>
               </table>
          </section>
